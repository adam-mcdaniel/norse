...
/* Command for C compiler:
   clang -c  -w  -I/Users/s777675/.choosenim/toolchains/nim-0.18.0/lib -o '/Users/s777675/Documents/Nim/Turing Tarpit/Nim/src/nimcache/stdlib_sequtils.o' '/Users/s777675/Documents/Nim/Turing Tarpit/Nim/src/nimcache/stdlib_sequtils.c' */
...
N_LIB_PRIVATE N_NIMCALL(tySequence_Zj5xKXgsXnI4n4hPS6nACA*, concat_ypF9bmw2tUJ9apRGN12wxsGA)(tySequence_Zj5xKXgsXnI4n4hPS6nACA** seqs, NI seqsLen_0) {
	...
	L = ((NI) 0);
	{
		tySequence_Zj5xKXgsXnI4n4hPS6nACA* seqitm;
		NI i;
		seqitm = (tySequence_Zj5xKXgsXnI4n4hPS6nACA*)0;
	...
	result = (tySequence_Zj5xKXgsXnI4n4hPS6nACA*) newSeq((&NTI_Zj5xKXgsXnI4n4hPS6nACA_), ((NI)chckRange(L, ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln_(43, "sequtils.nim");
	i_2 = ((NI) 0);
	{
		tySequence_Zj5xKXgsXnI4n4hPS6nACA* s;
		NI i_3;
		s = (tySequence_Zj5xKXgsXnI4n4hPS6nACA*)0;
		nimln_(2185, "system.nim");
		i_3 = ((NI) 0);
		{
			nimln_(2186, "system.nim");
